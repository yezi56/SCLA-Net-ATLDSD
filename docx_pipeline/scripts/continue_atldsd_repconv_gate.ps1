...
$SummaryScript = Join-Path $ProjectRoot "docx_pipeline\scripts\summarize_atldsd_candidate.py"
...
$LowCaScript = Join-Path $ProjectRoot "docx_pipeline\scripts\run_fast_lgc_lcsf_sp384_balanced_low_ca_screen.ps1"
$RelayLog = Join-Path $ProjectRoot "paper\notes\ATLDSD_training_relay_2026-06-10.md"
...
Add-RelayLog "RepConv summary gate says REJECT, RepConv process is gone, and Low-CA quick screen was started via `docx_pipeline/scripts/run_fast_lgc_lcsf_sp384_balanced_low_ca_screen.ps1`."
