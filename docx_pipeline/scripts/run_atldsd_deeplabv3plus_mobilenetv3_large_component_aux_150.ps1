...
$out = "$root\outputs\atldsd\deeplabv3plus_mobilenetv3_large_component_aux_150"
...
Write-Host "Started DeepLabV3+ MobileNetV3-Large Component-Aux training. PID=$($process.Id)"
