...
$out = "$root\outputs\atldsd\deeplabv3plus_mobilenetv3_large_component_aux_severity_150"
...
$cmd = @(
    ...
    "--severity-consistency-loss", "true",
    "--severity-consistency-weight", "0.1",
    "--severity-loss-type", "l1",
    "--num-workers", "0",
...
Write-Host "Started DeepLabV3+ MobileNetV3-Large Component-Aux + Severity-Consistency training. PID=$($process.Id)"
