...
RUN_ROOT="${PROJECT_ROOT}/outputs/atldsd/deeplabv3plus_mobilenetv3_large_component_aux_severity_150"
...
"${PYTHON_BIN}" "${PROJECT_ROOT}/src/models/deeplabv3plus/train.py" \
  ...
  --severity-consistency-weight "${SEVERITY_WEIGHT:-0.1}" \
  --severity-loss-type "${SEVERITY_LOSS_TYPE:-l1}" \
