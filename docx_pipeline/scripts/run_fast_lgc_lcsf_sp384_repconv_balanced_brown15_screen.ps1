...
foreach ($Seed in $Seeds) {
    $ExperimentName = "combo_lgc_lcsf_sp384_repconv_gray2_rust15_alt12_brown15_${TrainCount}_${ValCount}_e${Epochs}_s${Seed}"
    powershell -ExecutionPolicy Bypass -File $Runner `
        ...
        -PrefixWeights "gray=2,rust=1.5,alternaria=1.2,brown=1.5" `
