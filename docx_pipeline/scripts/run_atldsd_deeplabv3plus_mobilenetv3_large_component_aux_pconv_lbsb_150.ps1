...
$out = "$root\outputs\atldsd\deeplabv3plus_mobilenetv3_large_component_aux_pconv_lbsb_150"
...
Write-Host "Started Boundary2 DeepLabV3+ MobileNetV3-Large Component-Aux + PConv + LBSB training. PID=$($process.Id)"
