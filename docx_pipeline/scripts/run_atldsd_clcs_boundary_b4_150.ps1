...
$out = "$root\outputs\atldsd\clcs_boundary_deeplabv3plus_efficientnet_b4_150"
...
$cmd = @(
    ...
    "--eval-period", "10",
    "--num-workers", "0",
    "--use-boundary-head", "true",
    "--boundary-weight", "0.3",
    "--boundary-pos-weight", "5.0",
...
Write-Host "Started CLCS boundary Ours-B1 training. PID=$($process.Id)"
