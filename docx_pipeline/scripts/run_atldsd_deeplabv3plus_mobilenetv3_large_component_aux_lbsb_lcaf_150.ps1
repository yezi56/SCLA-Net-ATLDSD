...
$out = "$root\outputs\atldsd\deeplabv3plus_mobilenetv3_large_component_aux_lbsb_lcaf_150"
...
$cmd = @(
    ...
    "--lesion-cross-scale-fusion", "true",
    "--lesion-cross-scale-fusion-alpha", "0.5",
    "--num-workers", "0",
...
Write-Host "Started Fusion1 DeepLabV3+ MobileNetV3-Large Component-Aux + LBSB + LCAF training. PID=$($process.Id)"
