...
$out = "$root\outputs\atldsd\deeplabv3plus_mobilenetv3_large_component_aux_lbsb_lglc_150"
...
$cmd = @(
    ...
    "--lesion-local-global-context-alpha", "0.5",
    "--num-workers", "0",
...
Write-Host "Started Context1 DeepLabV3+ MobileNetV3-Large Component-Aux + LBSB + LGLC training. PID=$($process.Id)"
