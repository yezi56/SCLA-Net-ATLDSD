...
foreach ($Seed in $Seeds) {
    $ExperimentName = "combo_lgc_lcsf_sp384_repconv_balanced_chfr_v1_${TrainCount}_${ValCount}_e${Epochs}_s${Seed}"
    powershell -ExecutionPolicy Bypass -File $Runner `
        ...
        -ComponentHighFrequencyRefinement true `
        -ComponentHighFrequencyRefinementAlpha 0.2 `
