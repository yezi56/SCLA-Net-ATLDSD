...
$out = "$root\outputs\atldsd\deeplabv3plus_mobilenetv3_large_component_aux_pconv_150"
...
Write-Host "Started Mainline2 DeepLabV3+ MobileNetV3-Large Component-Aux + PConv training. PID=$($process.Id)"
