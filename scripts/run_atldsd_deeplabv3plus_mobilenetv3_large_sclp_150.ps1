...
$out = "$root\outputs\atldsd\deeplabv3plus_mobilenetv3_large_sclp_150"
...
Write-Host "Started DeepLabV3+ MobileNetV3-Large SCLP training. PID=$($process.Id)"
