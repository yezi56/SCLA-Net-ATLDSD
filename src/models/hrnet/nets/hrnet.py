...
class HRnet(nn.Module):
    def __init__(self, num_classes = 21, backbone = 'hrnetv2_w18', pretrained = False, attention_type = ""):
        ...
        self.fusion_attention = build_attention(attention_type, last_inp_channels)
