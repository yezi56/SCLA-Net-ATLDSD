...
class PSPNet(nn.Module):
    def __init__(self, num_classes, downsample_factor, backbone="resnet50", pretrained=True, aux_branch=True, attention_type=""):
        ...
        self.attention_aux = build_attention(attention_type, aux_channel)
        self.attention_main = build_attention(attention_type, out_channel)
    ...
    def forward(self, x):
        ...
        x_aux = self.attention_aux(x_aux)
        x = self.attention_main(x)
