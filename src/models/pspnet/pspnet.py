...
class PSPNet(object):
    ...
    def generate(self, onnx=False):
        ...
        #   载入模型与权值
        #-------------------------------#
        self.net    = pspnet(num_classes=self.num_classes, downsample_factor=self.downsample_factor, pretrained=False, backbone=self.backbone, aux_branch=False, attention_type=self.attention_type)
